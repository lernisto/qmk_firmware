...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT(
		         KC_Q,            KC_C,            KC_L,           KC_M,       KC_K,                                               KC_J,           KC_F,          KC_U,  KC_COMM,   KC_SCLN,
		         KC_I,            KC_S,    LALT_T(KC_R),   LGUI_T(KC_T),       KC_G,                                               KC_P,   RGUI_T(KC_N),  RALT_T(KC_E),   KC_A,      KC_O,
		         KC_Y,            KC_V,            KC_W,           KC_D,       KC_X,          KC_Z,             KC_BSLS,           KC_B,           KC_H,       KC_MINS,   KC_DOT,   KC_QUOT,
	...
	[_EXTEND] = LAYOUT(
		...
		OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL),  KC_RALT,                                KC_PGDN,  KC_LEFT,   KC_DOWN,   KC_RGHT,  KC_DEL,
			  KC_UNDO,        KC_CUT,       KC_COPY,       KC_PSTE,  KC_LGUI,  XXXXXXX,        KC_PSCR, /*?*/KC_RGUI,  KC_BSPC,    KC_TAB,    KC_APP,  KC_LOCK,  // KC_LOCK useful for locking SHIFT to select stuff
	...
	[_FUNCTION] = LAYOUT(
		...
		OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL),  KC_BRID,                               KC_F11,    KC_F4,     KC_F5,    KC_F6,  C(KC_MINS),
			  KC_SLCK,       KC_PAUS,       KC_MPRV,       KC_MNXT,  KC_STOP,  XXXXXXX,           XXXXXXX,   KC_F10,    KC_F1,     KC_F2,    KC_F3,  C(KC_0),
